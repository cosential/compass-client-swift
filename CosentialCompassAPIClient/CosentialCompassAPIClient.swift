...
public class CosentialCompassAPIClient {
    ...
    public class func getOpportunity(opportunityId: Int) {
        let endPoint = SERVER_URL + "opportunities/\(opportunityId)"
        
        callAPI(type: .get, name: "getOpportunity", endPoint: endPoint, parameters: [:], headers: AuthHeader, userInfo: nil)
    }
    ...
    public class func getProject(projectId: Int) {
        let endPoint = SERVER_URL + "projects/\(projectId)"
        
        callAPI(type: .get, name: "getProject", endPoint: endPoint, parameters: [:], headers: AuthHeader, userInfo: nil)
    }
    ...
    public class func getPersonnelOpportunities(personnelId: Int, parameters: [String : Any], info: Any?) {
        let endPoint = SERVER_URL + "personnel/\(personnelId)/opportunities"
        
        callAPI(type: .get, name: "getPersonnelOpportunities", endPoint: endPoint, parameters: parameters, headers: AuthHeader, userInfo: info)
    }
    
    public class func getPersonnelProjects(personnelId: Int, parameters: [String : Any], info: Any?) {
        let endPoint = SERVER_URL + "personnel/\(personnelId)/projects"
        
        callAPI(type: .get, name: "getPersonnelProjects", endPoint: endPoint, parameters: parameters, headers: AuthHeader, userInfo: info)
    }
    ...
    public class func getFirmOrgs() {
        let endPoint = SERVER_URL + "firmorgs"
        
        callAPI(type: .get, name: "getFirmOrgs", endPoint: endPoint, parameters: [:], headers: AuthHeader, userInfo: "")
    }
